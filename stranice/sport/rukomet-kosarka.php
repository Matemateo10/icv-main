<article class="featured">
    ...
    <a class="naslov" href="/sport/rukomet-kosarka">

        <h1>Rukomet - košarka</h1>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pr-30" id="istaknuto-rukomet">
        ...
        <div class="slagerx3 sport-slagerx3 pr-30">
            ...
            <div class="slagerx3-main slagerx3-oglas">
                ...
                <ins data-revive-zoneid="174" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <!-- Revive Adserver Asynchronous JS Tag - Generated with Revive Adserver v5.4.1 -->
                <ins data-revive-zoneid="210" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
                <script async src="//www.icvads.com/www/delivery/asyncjs.php"></script>
