<article class="featured">
    ...
    <a class="naslov" href="/sport/ostali-sportovi">
     ...
     <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <ins data-revive-zoneid="211" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pl-30" id="istaknuto-ostali-sportovi">
                
            <?php     
                
            $exclude_category = get_category_by_slug('istaknuto-sport')->term_id;
            $exclude_category2 = get_category_by_slug('istaknuto')->term_id;

            $args = array(
                'category_name' => 'ostali-sportovi',
        ...
        <!-- .slagerx2 .pl-30 #istaknuto-vijesti-->

        <div class="slagerx3 sport-slagerx3 pl-30">
            ...
            <div class="slagerx3-main slagerx3-oglas">
                ...
                <!-- Revive Adserver Asynchronous JS Tag - Generated with Revive Adserver v5.4.1 -->
                <ins data-revive-zoneid="176" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
                <script async src="//www.icvads.com/www/delivery/asyncjs.php"></script>
