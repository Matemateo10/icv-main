...
if ($adType === 'desktop-ad') {
    $file_path = ABSPATH . 'wp-content/themes/icvtheme/oglasi/vijesti/aktualno/' . $desktop_ad;
} else {
    $file_path = ABSPATH . 'wp-content/themes/icvtheme/oglasi/vijesti/aktualno/' . $mobile_ad;
}
