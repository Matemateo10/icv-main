...
if ($adType === 'desktop-ad') {
    $file_path = ABSPATH . 'wp-content/themes/icvtheme/oglasi/vijesti/zanimljivosti/' . $desktop_ad;
} else {
    $file_path = ABSPATH . 'wp-content/themes/icvtheme/oglasi/vijesti/zanimljivosti/' . $mobile_ad;
}
