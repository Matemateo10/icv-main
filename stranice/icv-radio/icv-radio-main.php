...
function get_ad_file($desktop_ad, $mobile_ad) {
    ...
    if ($adType === 'desktop-ad') {
        return ABSPATH . 'wp-content/themes/icvtheme/oglasi/icv-radio/' . $desktop_ad;
    } else {
        return ABSPATH . 'wp-content/themes/icvtheme/oglasi/icv-radio/' . $mobile_ad;
    }
}
