<article class="featured">
    ...
    <a class="naslov" href="/zupanije/viroviticko-podravska-zupanija">

        <h1>Virovitičko-podravska županija</h1>
    ...
    <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <ins data-revive-zoneid="201" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pl-30" id="istaknuto-vpz">
            ...
            $args = array(
                'category_name' => 'viroviticko-podravska-zupanija',
        ...
        <div class="slagerx3 pl-30">
            ...
            <div class="slagerx3-main slagerx3-oglas">
                ...
                <!-- Revive Adserver Asynchronous JS Tag - Generated with Revive Adserver v5.4.1 -->
                <ins data-revive-zoneid="154" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
                <script async src="//www.icvads.com/www/delivery/asyncjs.php"></script>
