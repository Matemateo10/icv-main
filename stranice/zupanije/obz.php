<article class="featured">
    ...
    <a class="naslov" href="/zupanije/osjecko-baranjska-zupanija">

        <h1>Osječko-baranjska županija</h1>
    ...
    <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <ins data-revive-zoneid="203" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pl-30" id="istaknuto-obz">
            ...
            $args = array(
                'category_name' => 'osjecko-baranjska-zupanija',
