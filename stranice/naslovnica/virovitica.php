<article class="featured">
    ...
    <a class="naslov" href="/virovitica">
    ...
    <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <ins data-revive-zoneid="190" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pl-30" id="istaknuto-virovitica">
            ...
            $args = array(
                'category_name' => 'istaknuto-virovitica',
            ...
            <div class="slagerx2-main">
                ...
                <a class="slagerx2-postdiv" href="<?php echo $post_permalink; ?>">
                        ...
                        <?php
                            ...
                            } elseif (has_category('istaknuto-virovitica')){
        ...
        <!-- .slagerx2 .pl-30" #istaknuto-virovitica -->
