<article class="featured">
    ...
    <a class="naslov" href="/opcine/slatina-sopje-cadavica-vocin-n-bukovica">

        <h1>Slatina - Sopje - Čađavica - Voćin - N.Bukovica</h1>
    ...
    <aside class="slager-aside">
        ...
        <div class="sticky">
            ...
            <div class="slager-aside-oglas">
                ...
                <ins data-revive-zoneid="207" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
    ...
    <div class="slager-parent">
        ...
        <div class="slagerx2 pl-30" id="istaknuto-slatina">
            ...
            $args = array(
                'category_name' => 'slatina-sopje-cadavica-vocin-n-bukovica',
        ...
        <div class="slagerx3 pl-30">
            ...
            <div class="slagerx3-main slagerx3-oglas">
                ...
                <!-- Revive Adserver Asynchronous JS Tag - Generated with Revive Adserver v5.4.1 -->
                <ins data-revive-zoneid="165" data-revive-id="987aaa8bfddb5a07fc66ba2d45209ef6"></ins>
                <script async src="//www.icvads.com/www/delivery/asyncjs.php"></script>
